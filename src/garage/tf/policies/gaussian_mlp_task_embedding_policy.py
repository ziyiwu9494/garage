...
class GaussianMLPTaskEmbeddingPolicy(GaussianMLPModel, TaskEmbeddingPolicy):
    ...
    def _initialize(self):
        ...
        dist, mean_var, log_std_var = self.build_network(
            obs_latent_input,
        ...
        dist_given_task, mean_g_t, log_std_g_t = self.build_network(
    ...
    def build(self, obs_input, task_input, name=None):
        ...
        with tf.compat.v1.variable_scope(self.name) as vs:
            ...
            return self.build_network(embed_state_input, name=name), enc_net
