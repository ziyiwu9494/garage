...
from garage.envs.wrappers.metaworld_scripted_reward import MWScriptedReward
...
def get_args(_seed=1, _gpu=None, _env_name=None):
    ...
    def sac_metaworldv2_test(ctxt=None):
        ...
        env = GarageEnv(MWScriptedReward(env_cls(random_init=False), scripted_policy=_scripted_policies[_ENV_NAME]()))
        ...
        sac = SAC(env_spec=env.spec,
                ...
                max_path_length=env.env.env.max_path_length,
                max_eval_path_length=env.env.env.max_path_length,
